...
module ModeFilter_hls_deadlock_idx0_monitor ( // for module ModeFilter_ModeFilter_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 ModeFilter_hls_deadlock_idx1_monitor ModeFilter_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),

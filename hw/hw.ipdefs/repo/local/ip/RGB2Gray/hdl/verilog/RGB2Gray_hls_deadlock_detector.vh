...
reg [15:0] trans_in_cnt_2;// for process gray2rgb_0_16_720_1280_1_2_2_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
...
reg [15:0] trans_out_cnt_2;// for process gray2rgb_0_16_720_1280_1_2_2_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
    ...
    RGB2Gray_hls_deadlock_detect_unit #(4, 0, 1, 1) RGB2Gray_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    RGB2Gray_hls_deadlock_detect_unit #(4, 1, 2, 2) RGB2Gray_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_start_FIFO_blk[1] = 1'b0 | (~start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U.if_full_n & rgb2gray_16_0_720_1280_1_2_2_U0.ap_start & ~rgb2gray_16_0_720_1280_1_2_2_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U.if_read);
    ...
    RGB2Gray_hls_deadlock_detect_unit #(4, 2, 2, 2) RGB2Gray_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~gray2rgb_0_16_720_1280_1_2_2_U0.grp_gray2rgb_0_16_720_1280_1_2_2_Pipeline_columnloop_fu_38.img1_data_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U.if_empty_n & gray2rgb_0_16_720_1280_1_2_2_U0.ap_idle & ~start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~gray2rgb_0_16_720_1280_1_2_2_U0.grp_gray2rgb_0_16_720_1280_1_2_2_Pipeline_columnloop_fu_38.img2_data_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U.if_full_n & gray2rgb_0_16_720_1280_1_2_2_U0.ap_start & ~gray2rgb_0_16_720_1280_1_2_2_U0.real_start & (trans_in_cnt_2 == trans_out_cnt_2) & ~start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U.if_read);
    ...
    RGB2Gray_hls_deadlock_detect_unit #(4, 3, 1, 1) RGB2Gray_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~xfMat2AXIvideo_24_16_720_1280_1_2_U0.grp_xfMat2AXIvideo_24_16_720_1280_1_2_Pipeline_loop_col_mat2axi_fu_76.img2_data_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U.if_empty_n & xfMat2AXIvideo_24_16_720_1280_1_2_U0.ap_idle & ~start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U.if_write);
...
`include "RGB2Gray_hls_deadlock_report_unit.vh"

...
module RGB2Gray_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign icmp_ln133_fu_185_p2 = ((ap_sig_allocacmp_j_7 == 11'd1920) ? 1'b1 : 1'b0);

assign img0_data_din = axi_data_fu_84;

assign j_8_fu_191_p2 = (ap_sig_allocacmp_j_7 + 11'd1);

assign last_out = last_reg_145;

assign or_ln139_fu_197_p2 = (ap_phi_mux_start_phi_fu_159_p4 | ap_phi_mux_last_phi_fu_148_p4);

endmodule //RGB2Gray_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat

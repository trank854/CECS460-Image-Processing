...
entity RGB2Gray_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of RGB2Gray_AXIvideo2xfMat_24_16_1080_1920_1_2_Pipeline_loop_col_zxi2mat is 
...
begin
    ...
    ap_sig_allocacmp_j_7_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_76)
    begin
    ...
    icmp_ln133_fu_185_p2 <= "1" when (ap_sig_allocacmp_j_7 = ap_const_lv11_780) else "0";
    ...
    j_8_fu_191_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_7) + unsigned(ap_const_lv11_1));

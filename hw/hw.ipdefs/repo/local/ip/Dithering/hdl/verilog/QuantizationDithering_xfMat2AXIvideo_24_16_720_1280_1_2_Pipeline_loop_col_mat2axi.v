...
module QuantizationDithering_xfMat2AXIvideo_24_16_720_1280_1_2_Pipeline_loop_col_mat2axi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((stream_out_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (img1_data_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((stream_out_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (img1_data_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((stream_out_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (img1_data_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((stream_out_TREADY == 1'b0) & (icmp_ln199_reg_171 == 1'd0)) | ((icmp_ln199_reg_171 == 1'd0) & (img1_data_empty_n == 1'b0)));
end
...
assign stream_out_TDATA = img1_data_dout;
...
endmodule //QuantizationDithering_xfMat2AXIvideo_24_16_720_1280_1_2_Pipeline_loop_col_mat2axi

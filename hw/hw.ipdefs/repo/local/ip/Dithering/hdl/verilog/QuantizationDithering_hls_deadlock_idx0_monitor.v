...
module QuantizationDithering_hls_deadlock_idx0_monitor ( // for module QuantizationDithering_QuantizationDithering_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 QuantizationDithering_hls_deadlock_idx1_monitor QuantizationDithering_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),

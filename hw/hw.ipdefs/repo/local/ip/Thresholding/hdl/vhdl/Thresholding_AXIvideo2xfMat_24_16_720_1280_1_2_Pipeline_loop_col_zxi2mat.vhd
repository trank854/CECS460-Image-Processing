...
entity Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_Pipeline_loop_col_zxi2mat is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_Pipeline_loop_col_zxi2mat is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_j_9 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_const_boolean_1 = ap_condition_220)) then 
                    axi_data_fu_84 <= stream_in_TDATA;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_const_boolean_1 = ap_condition_220)) then 
                    axi_last_3_fu_80 <= stream_in_TLAST;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, stream_in_TVALID, ap_predicate_op35_read_state1, img0_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img0_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (stream_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, stream_in_TVALID, ap_predicate_op35_read_state1, img0_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img0_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (stream_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, stream_in_TVALID, ap_predicate_op35_read_state1, img0_data_full_n, icmp_ln133_reg_259, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln133_reg_259 = ap_const_lv1_0) and (img0_data_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (stream_in_TVALID = ap_const_logic_0) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(stream_in_TVALID, ap_predicate_op35_read_state1)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_predicate_op35_read_state1 = ap_const_boolean_1) and (stream_in_TVALID = ap_const_logic_0));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(img0_data_full_n, icmp_ln133_reg_259)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((icmp_ln133_reg_259 = ap_const_lv1_0) and (img0_data_full_n = ap_const_logic_0));
    end process;
    ...
    ap_sig_allocacmp_j_9_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_76)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_9 <= ap_const_lv11_0;
        else 
    ...
    icmp_ln133_fu_185_p2 <= "1" when (ap_sig_allocacmp_j_9 = ap_const_lv11_500) else "0";

    img0_data_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, img0_data_full_n, icmp_ln133_reg_259, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (icmp_ln133_reg_259 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img0_data_blk_n <= img0_data_full_n;
        else 
            img0_data_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    img0_data_din <= axi_data_fu_84;

    img0_data_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln133_reg_259, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln133_reg_259 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            img0_data_write <= ap_const_logic_1;
        else 
            img0_data_write <= ap_const_logic_0;
        end if; 
    end process;

    j_10_fu_191_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_9) + unsigned(ap_const_lv11_1));
    ...
    stream_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, stream_in_TVALID, ap_predicate_op35_read_state1, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    stream_in_TREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_predicate_op35_read_state1, ap_block_pp0_stage0_11001, ap_start_int)
    begin

...
module Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_Pipeline_loop_col_zxi2mat (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln133_reg_259 == 1'd0) & (img0_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op35_read_state1 == 1'b1) & (stream_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln133_reg_259 == 1'd0) & (img0_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op35_read_state1 == 1'b1) & (stream_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln133_reg_259 == 1'd0) & (img0_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_predicate_op35_read_state1 == 1'b1) & (stream_in_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_predicate_op35_read_state1 == 1'b1) & (stream_in_TVALID == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((icmp_ln133_reg_259 == 1'd0) & (img0_data_full_n == 1'b0));
end
...
assign icmp_ln133_fu_185_p2 = ((ap_sig_allocacmp_j_9 == 11'd1280) ? 1'b1 : 1'b0);

assign img0_data_din = axi_data_fu_84;

assign j_10_fu_191_p2 = (ap_sig_allocacmp_j_9 + 11'd1);

assign last_out = last_reg_145;

assign or_ln139_fu_197_p2 = (ap_phi_mux_start_phi_fu_159_p4 | ap_phi_mux_last_phi_fu_148_p4);

endmodule //Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_Pipeline_loop_col_zxi2mat

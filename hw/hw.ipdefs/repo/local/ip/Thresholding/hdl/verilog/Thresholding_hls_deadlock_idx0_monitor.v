...
module Thresholding_hls_deadlock_idx0_monitor ( // for module Thresholding_Thresholding_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 Thresholding_hls_deadlock_idx1_monitor Thresholding_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),

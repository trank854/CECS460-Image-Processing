...
module Thresholding_rgb2gray_16_0_720_1280_1_2_2_Pipeline_columnloop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
Thresholding_mul_8ns_15ns_22_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
Thresholding_mac_muladd_8ns_12ns_22ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
...
Thresholding_mac_muladd_8ns_15ns_22ns_23_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_1_reg_192 <= {{img0_data_dout[15:8]}};
...
assign grp_fu_159_p00 = p_2_fu_120_p4;

assign grp_fu_159_p1 = 20'd3736;

assign grp_fu_167_p0 = grp_fu_167_p00;

assign grp_fu_167_p00 = p_1_reg_192;
...
assign icmp_ln5506_fu_89_p2 = ((ap_sig_allocacmp_j_3 == width) ? 1'b1 : 1'b0);

assign img1_data_din = {{grp_fu_167_p3[22:15]}};

assign j_4_fu_95_p2 = (ap_sig_allocacmp_j_3 + 11'd1);

assign mul_ln886_fu_140_p0 = mul_ln886_fu_140_p00;

assign mul_ln886_fu_140_p00 = p_reg_187;

assign mul_ln886_fu_140_p1 = 22'd9798;

assign p_2_fu_120_p4 = {{img0_data_dout[23:16]}};

assign p_fu_106_p1 = img0_data_dout[7:0];

endmodule //Thresholding_rgb2gray_16_0_720_1280_1_2_2_Pipeline_columnloop

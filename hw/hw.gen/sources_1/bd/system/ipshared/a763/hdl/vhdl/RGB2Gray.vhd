...
architecture behav of RGB2Gray is 
    ...
    "RGB2Gray_RGB2Gray,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.268000,HLS_SYN_LAT=929527,HLS_SYN_TPT=929528,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=758,HLS_SYN_LUT=1329,HLS_VERSION=2023_1}";
    ...
    signal gray2rgb_0_16_720_1280_1_2_2_U0_img1_data_read : STD_LOGIC;
    signal gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_din : STD_LOGIC_VECTOR (23 downto 0);
    signal gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_write : STD_LOGIC;
    ...
    signal xfMat2AXIvideo_24_16_720_1280_1_2_U0_img2_data_read : STD_LOGIC;
    ...
    component RGB2Gray_AXIvideo2xfMat_24_16_720_1280_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component RGB2Gray_rgb2gray_16_0_720_1280_1_2_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component RGB2Gray_gray2rgb_0_16_720_1280_1_2_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        img2_data_din : OUT STD_LOGIC_VECTOR (23 downto 0);
    ...
    component RGB2Gray_xfMat2AXIvideo_24_16_720_1280_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component RGB2Gray_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component RGB2Gray_fifo_w10_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component RGB2Gray_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component RGB2Gray_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component RGB2Gray_start_for_rgb2gray_16_0_720_1280_1_2_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component RGB2Gray_start_for_gray2rgb_0_16_720_1280_1_2_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component RGB2Gray_start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    AXIvideo2xfMat_24_16_720_1280_1_2_U0 : component RGB2Gray_AXIvideo2xfMat_24_16_720_1280_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    rgb2gray_16_0_720_1280_1_2_2_U0 : component RGB2Gray_rgb2gray_16_0_720_1280_1_2_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    gray2rgb_0_16_720_1280_1_2_2_U0 : component RGB2Gray_gray2rgb_0_16_720_1280_1_2_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        img1_data_read => gray2rgb_0_16_720_1280_1_2_2_U0_img1_data_read,
        img2_data_din => gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_din,
        img2_data_num_data_valid => img2_data_num_data_valid,
        img2_data_fifo_cap => img2_data_fifo_cap,
        img2_data_full_n => img2_data_full_n,
        img2_data_write => gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_write);

    xfMat2AXIvideo_24_16_720_1280_1_2_U0 : component RGB2Gray_xfMat2AXIvideo_24_16_720_1280_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ...
        img2_data_read => xfMat2AXIvideo_24_16_720_1280_1_2_U0_img2_data_read,
    ...
    img0_data_U : component RGB2Gray_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    img0_rows_c_U : component RGB2Gray_fifo_w10_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img0_cols_c_U : component RGB2Gray_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img1_data_U : component RGB2Gray_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => gray2rgb_0_16_720_1280_1_2_2_U0_img1_data_read);

    img2_data_U : component RGB2Gray_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_din,
        if_full_n => img2_data_full_n,
        if_write => gray2rgb_0_16_720_1280_1_2_2_U0_img2_data_write,
        ...
        if_read => xfMat2AXIvideo_24_16_720_1280_1_2_U0_img2_data_read);

    start_for_rgb2gray_16_0_720_1280_1_2_2_U0_U : component RGB2Gray_start_for_rgb2gray_16_0_720_1280_1_2_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U : component RGB2Gray_start_for_gray2rgb_0_16_720_1280_1_2_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U : component RGB2Gray_start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,

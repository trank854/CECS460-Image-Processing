...
architecture behav of Thresholding is 
    ...
    "Thresholding_Thresholding,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.268000,HLS_SYN_LAT=929528,HLS_SYN_TPT=929528,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=890,HLS_SYN_LUT=1589,HLS_VERSION=2023_1}";
    ...
    signal Threshold_0_0_720_1280_1_2_2_U0_img1_data_read : STD_LOGIC;
    ...
    signal start_for_Threshold_0_0_720_1280_1_2_2_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Threshold_0_0_720_1280_1_2_2_U0_full_n : STD_LOGIC;
    signal start_for_Threshold_0_0_720_1280_1_2_2_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component Thresholding_rgb2gray_16_0_720_1280_1_2_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Thresholding_Threshold_0_0_720_1280_1_2_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Thresholding_gray2rgb_0_16_720_1280_1_2_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Thresholding_xfMat2AXIvideo_24_16_720_1280_1_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Thresholding_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component Thresholding_fifo_w10_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_start_for_rgb2gray_16_0_720_1280_1_2_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_start_for_Threshold_0_0_720_1280_1_2_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_start_for_gray2rgb_0_16_720_1280_1_2_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Thresholding_start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    AXIvideo2xfMat_24_16_720_1280_1_2_U0 : component Thresholding_AXIvideo2xfMat_24_16_720_1280_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    rgb2gray_16_0_720_1280_1_2_2_U0 : component Thresholding_rgb2gray_16_0_720_1280_1_2_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Threshold_0_0_720_1280_1_2_2_U0 : component Thresholding_Threshold_0_0_720_1280_1_2_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    gray2rgb_0_16_720_1280_1_2_2_U0 : component Thresholding_gray2rgb_0_16_720_1280_1_2_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    xfMat2AXIvideo_24_16_720_1280_1_2_U0 : component Thresholding_xfMat2AXIvideo_24_16_720_1280_1_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    img0_data_U : component Thresholding_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    img0_rows_c_U : component Thresholding_fifo_w10_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img0_cols_c_U : component Thresholding_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img1_data_U : component Thresholding_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img2_data_U : component Thresholding_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img3_data_U : component Thresholding_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_rgb2gray_16_0_720_1280_1_2_2_U0_U : component Thresholding_start_for_rgb2gray_16_0_720_1280_1_2_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Threshold_0_0_720_1280_1_2_2_U0_U : component Thresholding_start_for_Threshold_0_0_720_1280_1_2_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_gray2rgb_0_16_720_1280_1_2_2_U0_U : component Thresholding_start_for_gray2rgb_0_16_720_1280_1_2_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0_U : component Thresholding_start_for_xfMat2AXIvideo_24_16_720_1280_1_2_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Threshold_0_0_720_1280_1_2_2_U0_ap_start <= start_for_Threshold_0_0_720_1280_1_2_2_U0_empty_n;
    ...
    start_for_Threshold_0_0_720_1280_1_2_2_U0_din <= (0=>ap_const_logic_1, others=>'-');
